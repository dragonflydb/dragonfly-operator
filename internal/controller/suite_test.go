...
var _ = BeforeSuite(func() {
	...
	testEnv = &envtest.Environment{
		...
		// Use existing cluster so that we can access pods
	...
	eventRecorder := eventBroadcaster.NewRecorder(scheme.Scheme, v1.EventSource{Component: "dragonfly-operator"})
